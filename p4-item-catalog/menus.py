...
menuItem1 = MenuItem(name="Camarão com Molho Especial", 
                     description="Spaghettini ao molho especial Giraffas e 120g de camarão.",
...
menuItem2 = MenuItem(name="Iscas de Filé Mignon com Molho de Ervas com Alho", 
                     description=" Spaghettini ao molho de ervas com alho e 110g de iscas de carne.",
...
menuItem3 = MenuItem(name="Iscas de Peito de Frango com Molho ao Sugo", 
                     description="Spaghettini ao molho sugo e 120g de iscas de frango.",
...
menuItem1 = MenuItem(name="Tilápia Pescador",
                     description="Filé de Tilápia grelhado com cebolas, alcaparras e salsinha. Acompanha arroz de alho e batata soutê.",
...
menuItem2 = MenuItem(name="Peixe c/ Crosta de Pão",
                     description="Filet de peixe com crosta crocante de pão, acompanha talharim à alho e óleo, e legumes.",
...
menuItem3 = MenuItem(name="Peixe à Dorê",
                     description="Filé de peixe empanado, acompanha anéis de cebola empanados, arroz branco e batata gratinada.",
